  ...
  def train(self):
    ...
    for self.step in tqdm(range(start_step, self.max_step), ncols=70, initial=start_step):
      ...
      if self.step < self.learn_start:
        ...
        action = self.env.env.name_action_mapping[action]
    ...
    with tf.variable_scope('prediction'):
      if self.cnn_format == 'NHWC':
        self.s_t = tf.placeholder('float32',
            [None, self.screen_height, self.screen_width, self.screen_channels], name='s_t')
      else:
        self.s_t = tf.placeholder('float32',
            [None, self.screen_channels, self.screen_height, self.screen_width], name='s_t')

      self.l1, self.w['l1_w'], self.w['l1_b'] = conv2d(self.s_t,
          32, [2, 2], [2, 2], initializer, activation_fn, self.cnn_format, name='l1')
      self.l2, self.w['l2_w'], self.w['l2_b'] = conv2d(self.l1,
          64, [2, 2], [2, 2], initializer, activation_fn, self.cnn_format, name='l2')
    ...
    with tf.variable_scope('target'):
      if self.cnn_format == 'NHWC':
        self.target_s_t = tf.placeholder('float32',
            [None, self.screen_height, self.screen_width, self.screen_channels], name='target_s_t')
      else:
        self.target_s_t = tf.placeholder('float32',
            [None, self.screen_channels, self.screen_height, self.screen_width], name='target_s_t')

      self.target_l1, self.t_w['l1_w'], self.t_w['l1_b'] = conv2d(self.target_s_t,
          32, [2, 2], [2, 2], initializer, activation_fn, self.cnn_format, name='target_l1')
      self.target_l2, self.t_w['l2_w'], self.t_w['l2_b'] = conv2d(self.target_l1,
          64, [2, 2], [2, 2], initializer, activation_fn, self.cnn_format, name='target_l2')
